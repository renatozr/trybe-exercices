// 2 -Utilizando a sintaxe de async/await, faça um teste que verifique o resultado da função getUserName para o caso em que o usuário 
...
describe('Testando a função getUserName', () => {
  it('Teste com id existente', async () => {
    await expect(getUserName(1)).resolves.toBe('Mark');
  });
  it('Teste com id não existente', async () => {
